...
class App{
    ...
    initPages() {
        ...
        <div id="main">
            ...
            <div id="title">
                Life Simulator<br>
                <div style="font-size:1.5rem; font-weight:normal;">Modified by lijunhao2023</div>
            </div>
            <button id="restart" class="mainbtn"><span class="iconfont">&#xe6a7;</span>Start</button>
            <a href="https://www.luogu.com.cn/user/487106"><button class="btn">Follow me on 洛谷</button></a>
        </div>
        `);
        ...
        const talentPage = $(`
        <div id="main">
            <div class="head" style="font-size: 1.6rem">Choose your Talents</div>
            <button id="random" class="mainbtn" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);"">10 of them</button>
            <ul id="talents" class="selectlist"></ul>
            <button id="next" class="mainbtn">请选择5个</button>
        </div>
        `);
                        ...
                        li.click(()=>{
                            if(li.hasClass('selected')) {
                                ...
                                if(this.#talentSelected.size==3) {
                                    talentPage.find('#next').text('Start')
                                }
                            }
                        });
                    });
        ...
        <div id="main">
            ...
            <div class="btn-area">
                <button id="random" class="mainbtn">随机</button>
